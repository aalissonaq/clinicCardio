                                    ...
                                    <ul class="nav justify-content-center">
                                        ...
                                        ";
                                            ...
                                            <li class=\"nav-item\">
                                              ...
                                              title=\"Editar Usuário\" rel=\"noopener noreferrer\">
                                                <!-- <i class=\"fas fa-pen fa-lg\"></i> -->
                                                <i class=\"mdi mdi-account-edit-outline  fa fa-2x\"></i>
                                              </a>
                                            </li>
        ...
        <div class="modal-content">
                ...
                <form class="needs-validation" novalidate action="pages/pages/acoes/gravaNovoPaciente.php" method="POST"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="docPessoa" class="form-control text-uppercase js_cpf"
                                   id="docPessoa" placeholder="Somente Números">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" name="dtNascPessoa"
                                   class="form-control text-uppercase js_data dtNascPessoa" onblur="Idade();"
                                   id="dtNascPessoa" placeholder="dd/mm/yyyy" required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        ...
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="nnRg" class="form-control text-uppercase" id="nnRg"
                                   placeholder="">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" required name="nmMae" class="form-control text-uppercase" id="nmMae"
                                   placeholder="">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="nmPai" class="form-control text-uppercase" id="nmPai"
                                   placeholder="">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            <label for="nmResponsavel">Responsável <small
                                    class="text-danger text-uppercase">(Obrigatório para menores
                                    de 18
                                    anos)</small></label>
                            <input type="text" name="nmResponsavel" class="form-control text-uppercase"
                                   id="nmResponsavel" placeholder="quando responvel">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" name="stLogradouroPessoa" class="form-control text-uppercase"
                                   id="stLogradouroPessoa" placeholder="" required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="number" name="nnCasaPessoa" class="form-control text-uppercase"
                                   id="nnCasaPessoa" placeholder="" required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="text" name="stCompleEndPessoa" class="form-control text-uppercase"
                                   id="stCompleEndPessoa" placeholder="">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="stBairroPessoa" class="form-control text-uppercase"
                                   id="stBairroPessoa" placeholder="" required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="stEmailPessoa" class="form-control" id="stEmailPessoa"
                                   placeholder="">
                            <div class="invalid-feedback">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="button" class="btn btn-danger" data-dismiss="modal"><i
                        class="fas fa-times fa-fw fa-lg"></i>
                    Fechar </button>
