...
<section class="content">
  <?php
    $idEdit = $_GET['idEdit'];
    $dBancada = ler("bancadaexame", '', "WHERE idBancada = '{$idEdit}'")->fetchAll(PDO::FETCH_ASSOC);
    foreach ($dBancada as $dbanc) {
        ?>

  <!-- Default box -->
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Editar Bancada: 
        <small class="lead text-primary text-uppercase"><?= $dbanc['nmBancada']; ?></small>
      </h3>
    ...
    <div class="card-body">
      ...
      <form class="needs-validation" novalidate action="pages/pages/acoes/editarBancada.php" method="POST"
        enctype="multipart/form-data">
        <input type="hidden" name="idEdt" value="<?= $_GET['idEdit'];?>">
        <div class="form-row">
          ...
          <div class="col-md-12 mb-3">
            ...
            <input type="text" name="nmBancada" class="form-control text-uppercase" id="nmBancada" placeholder=""
              required value="<?= $dbanc['nmBancada']; ?>">
