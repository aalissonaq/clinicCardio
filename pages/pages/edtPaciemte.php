        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Edição de Dados do Pacientes</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
    ...
    foreach ($dadosPessoa as $dpaciente) {
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Editar o Paciente:
                    <small class="lead text-primary text-uppercase"><?= $dpaciente['nmPessoa']; ?></small>
                </h3>

                <div class="card-tools">
                    <a href="?page=listarPaciantes" class="btn btn-tool text-primary">
                    ...
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" name="dtNascPessoa" class="form-control text-uppercase js_data dtNascPessoa"
                                   onblur="Idade();" id="dtNascPessoa" placeholder="dd/mm/yyyy"
                                   value="<?= $dpaciente['dtNascPessoa']; ?>" required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" name="strNaturalidadePaciente" class="form-control text-uppercase"
                                   id="strNaturalidadePaciente" value="<?= $dpaciente['strNaturalidadePaciente']; ?>"
                                   placeholder="">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" required name="nmMae" class="form-control text-uppercase" id="nmMae"
                                   placeholder="" value="<?= $dpaciente['nmMae']; ?>">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" name="nmResponsavel" class="form-control text-uppercase" id="nmResponsavel"
                                   placeholder="quando responvel" value="<?= $dpaciente['nmResponsavel']; ?>">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-2 mb-3">
                            ...
                            <input type="text" name="stCepPessoa" class="form-control text-uppercase js_cep"
                                   id="stCepPessoa" placeholder="" value="<?= $dpaciente['stCepPessoa']; ?>">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                        ...
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" name="stLogradouroPessoa" class="form-control text-uppercase"
                                   id="stLogradouroPessoa" placeholder="" value="<?= $dpaciente['stLogradouroPessoa']; ?>"
                                   required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-5 mb-3">
                            ...
                            <input type="text" name="stCompleEndPessoa" class="form-control text-uppercase"
                                   id="stCompleEndPessoa" placeholder="" value="<?= $dpaciente['stCompleEndPessoa']; ?>">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="nnTelefonePessoa" class="form-control text-uppercase js_fone"
                                   id="nnTelefonePessoa" placeholder="" value="<?= $dpaciente['nnTelefonePessoa']; ?>"
                                   required>
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="text" name="nnWhatsappPessoa" class="form-control text-uppercase js_fone"
                                   id="nnWhatsappPessoa" placeholder="" value="<?= $dpaciente['nnWhatsappPessoa']; ?>">
                            <div class="invalid-feedback">
                                Obrigatório !
                            </div>
                        </div>
            ...
            <div class="modal-footer justify-content-between">
                ...
                <a href="?page=listarPaciantes" class="btn btn-danger">
