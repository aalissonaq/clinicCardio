...
<section class="content">
  ...
  <div class="card">
    <div class="card-header">
      <h3 class="card-title">Lista de Usuários
      ...
      <div class="table-responsive">
        <table id="tabela" class="table table-sm table-striped table-hover">
          ...
          <tbody>
            ...
            ?>
            <tr>
              <td class="text-center align-middle"><?= str_pad($cont, 2, "0", STR_PAD_LEFT); ?>
              </td>
  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title">Novo Usuários do Sistema</h4>
      ...
      <div class="modal-body">
        ...
        <form class="needs-validation" novalidate action="pages/pages/acoes/gravaNovoUsuario.php" method="POST"
          ...
          <div class="form-row">
            <div class="col-md-3 mb-3">
              <label for="dtNascPessoa">Data de Nasc./Criação</label>
            ...
            <div class="col-md-2 mb-3">
              ...
              <input type="text" name="stCepPessoa" class="form-control text-uppercase js_cep" id="stCepPessoa"
                placeholder="" onblur="pesquisacep(this.value)">
              <div class="invalid-feedback">
                Obrigatório !
              </div>
            </div>
          ...
          <div class="form-row">
            <div class="col-md-12 mb-3">
              ...
              <textarea class="form-control text-uppercase js_textareaEdt3" rows="3"
                name="txtObsContatosPessoas">Recados, falar com</textarea>
              <div class="invalid-feedback">
                Obrigatório !
              </div>
            </div>
