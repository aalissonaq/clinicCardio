...
<section class="content">
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate action="pages/pages/acoes/gravaNovoExame.php" method="POST"
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="sinonimos" class="form-control text-uppercase" id="sinonimos" placeholder=""
                               required>
                        <div class="invalid-feedback">
                            Obrigatório !
                        </div>
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <input type="text" name="material" class="form-control text-uppercase" id="material" placeholder=""
                               required>
                        <div class="invalid-feedback">
                ...
                <div class="form-row">
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control text-uppercase js_textareaEdt textarea" placeholder="" rows="5"
                                  name="interpretacaoexame">
                        </textarea>
                        <div class="invalid-feedback">
                            Este Campo é Obrigatório !
                        </div>
                ...
                <div class="form-row">
                    ...
                    <div class="col-md-3 mb-3">
                        ...
                        <textarea class="form-control text-uppercase js_edtNoToolBar" placeholder="" parametroexame rows="5"
                                  name="parametroexame">
                        </textarea>
                        <div class="invalid-feedback">
                            Este Campo é Obrigatório !
                    ...
                    <div class="col-md-5 mb-3">
                        ...
                        <textarea class="form-control text-uppercase js_edtNoToolBar" placeholder="" rows="5"
                                  name="valorReferenciaExame">
                        </textarea>
                        <div class="invalid-feedback">
                            Este Campo é Obrigatório !
                        </div>
                ...
                <div class="form-row ">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="instrucoesPreparoExame" class="form-control" id="instrucoesPreparoExame"
                               placeholder="">
                        <div class="invalid-feedback ">
                            .) !
                        </div>
