...
<section class="content">
    <div class="d-none d-print-block col-md-12 mb-1  bg-dark">
        <img src="./image/logo.png" class="img-fluid ${3|rounded-top,rounded-right,rounded-bottom,rounded-left,rounded-circle,|} col-md-4 mb-3" alt=""><br />
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title text-uppercase">Dados do Usuário do Sistema
                <small class="lead text-primary text-uppercase"></small>
            </h3>

            <div class="card-tools">
                <a href="?page=listarusuarios" class="btn btn-tool text-primary d-print-none">
        ...
        <div class="card-body">
            ...
            <form class="needs-validation" novalidate action="pages/pages/acoes/editarUsuario.php" method="POST" enctype="multipart/form-data">
