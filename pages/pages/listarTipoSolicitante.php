        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Tipo de Solicitante</li>
                </ol>
            </div>
        </div>
    </div><!-- /.container-fluid -->
...
<section class="content">
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Lista de Tipo de Solicitante
            </h3>
            ...
            <table id="tabela" class="table table-sm table-striped table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="col-md-auto text-center text-uppercase align-middle">Tipo de Solicitante</th>
                ...
                <tbody>
                    <?php
                    $cont = 0;
                    $ler = ler("tiposolicitante", '', "ORDER BY idTipoSolicitanta ASC");
                    ...
                    foreach ($listar as $dados) {
                        ...
                        <tr>
                            ...
                            <td class="text-uppercase align-middle"><?php echo $dados['descricaoTipoSolicitante']; ?>
                            </td>
                            ...
                            <td class="">
                                <ul class="nav justify-content-center align-middle">
                                    ...
                                    echo "<li class=\"nav-item\">
                                      <a href=\"?page=&idEdit={$dados['idTipoSolicitanta']}\" class=\"btn btn-tool\" target=\"\" title=\"Editar Exame\" rel=\"noopener noreferrer\">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Novo Tipo de Solicitante</h4>
            ...
            <div class="modal-body">
                ...
                <form class="needs-validation" novalidate action="pages/pages/acoes/gravaNovaTipoSolicitante.php"
                      method="POST" enctype="multipart/form-data">
                    <div class="form-row">

                        <div class="col-md-12 mb-3">
                            <label for="descricaoTipoSolicitante">TIPO DE SOLICITANTE</label>
                            <input type="text" name="descricaoTipoSolicitante" class="form-control text-uppercase"
                                   id="descricaoTipoSolicitante" placeholder="" required>
...
<script>
        ...
        document.getElementById('solicitanteMenu').classList.add("menu-open");
        document.getElementById('tipoSolicitanteActiva').classList.add("active");
